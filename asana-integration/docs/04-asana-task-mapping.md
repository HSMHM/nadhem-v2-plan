...
1. **حلقة 1:** كل المهام الرئيسية الـ19 (لتظهر مرتّبة حسب id في القسم)
...
|-------|------|
| المهام الرئيسية | 19 |
| حاويات المراحل (4 لكل تطوير) | 76 |
| المهام التفصيلية (مجموع كل المصفوفات) | ~317 |
| **إجمالي المهام في أسانا** | **~412** |
| المرفقات الرئيسية | 19 |
| المرفقات التفصيلية | ~317 |
| **إجمالي المرفقات** | **~336** |

> العدد الفعلي للمهام التفصيلية: مجموع `analysis.length + design.length + implementation.length + training.length` لكل من الـ19 — يُحسب في وقت التشغيل.
