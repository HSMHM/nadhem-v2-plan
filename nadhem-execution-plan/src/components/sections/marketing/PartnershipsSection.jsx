...
const partnerships = [
  {
    ...
    title: 'المجالس',
    description: 'بناء علاقات شراكة مع المجالس — قنوات إحالة عالية الأثر للوصول إلى المنظمين الرسميين.',
    actions: [
      'تحديد المجالس المستهدفة وأولوية كل منها',
      'التواصل الرسمي وعقد لقاءات تعريفية بالمنتج',
      'الاتفاق على آلية إحالة وتعاون مستمر',
    ],
    color: '#2A848A',
  },
  {
    icon: 'hand-holding-heart',
    title: 'المركز الوطني للقطاع غير الربحي',
    description: 'بناء علاقة شراكة مع المركز الوطني للقطاع غير الربحي للوصول إلى الجمعيات والمؤسسات تحت مظلته.',
    actions: [
      'التواصل الرسمي مع إدارة المركز وعرض القيمة',
      'تقديم نظم كحل تقني معتمد للجمعيات والمؤسسات',
      'الاتفاق على آلية ترشيح وإحالة المنظمات للمنتج',
    ],
    color: '#A61C61',
  },
  {
