const agenda = [
  ...
  { num: '2', title: 'التطويرات المطلوبة', desc: '22 تطويراً مع 416 مهمة تفصيلية موزعة على 4 فترات (مايو – ديسمبر)', plan: 'التطوير' },
  { num: '3', title: 'رحلة منصة العميل', desc: '28 وحدة موزعة على مراحل الفعالية + 4 باقات سنوية + AI كمكمّل — هيكلة المنتج ونموذج التسعير', plan: 'المنصة' },
  { num: '4', title: 'الخطة التشغيلية', desc: '43 مهمة تشغيلية دورية — تمكين العملاء، تشغيل الفعاليات الحضورية، متابعة الاشتراكات، دراسة المنافسين', plan: 'التشغيل' },
  ...
  { num: '7', title: 'خطة اكتساب العملاء', desc: 'هدف 30-40 عميل نهاية 2026 — قنوات الوصول وشرائح العملاء', plan: 'التسويق' },
  { num: '8', title: 'الجدول الزمني والمستهدفات', desc: 'خارطة التنفيذ على 8 أشهر مع مؤشرات أداء قابلة للقياس', plan: 'الثلاثة' },
];

const planColor = { 'التطوير': '#2A848A', 'التشغيل': '#BA5A31', 'التسويق': '#A61C61', 'المنصة': '#F59E0B', 'الثلاثة': '#452059' };
