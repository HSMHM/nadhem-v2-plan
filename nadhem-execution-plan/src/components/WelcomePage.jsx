...
const agenda = [
  ...
  { num: '2', title: 'التطويرات المطلوبة', desc: '13 تطويراً مع 289 مهمة تفصيلية موزعة على 4 فترات (مايو – ديسمبر)', plan: 'التطوير' },
  { num: '3', title: 'الوحدات والباقات', desc: '16 وحدة وظيفية و4 باقات سنوية — هيكلة المنتج ونموذج التسعير', plan: 'التطوير' },
  { num: '4', title: 'الخطة التشغيلية', desc: '33 مهمة تشغيلية دورية — تمكين العملاء، متابعة الاشتراكات، دراسة المنافسين', plan: 'التشغيل' },
