...
export const roadmapDevelopments = {
  ...
  structure: [
    { title: 'نظام الوحدات والباقات', description: 'تقسيم النظام إلى 29 وحدة (موزعة على مراحل الفعالية) ضمن 4 باقات سنوية، مع مصفوفة وحدات × باقات كاملة', priority: 'high', icon: 'puzzle-piece' },
