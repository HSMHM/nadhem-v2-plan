...
export const roadmapDevelopments = {
  urgent: [
    ...
    { title: 'إعادة تصميم واجهات الإدمن + ثيمان للواجهة الخارجية', description: 'تسليم واجهات الإدمن حتى 23 أبريل، والثيم 1 + الثيم 2 للواجهة الخارجية خلال أسبوعين إضافيين', priority: 'urgent', icon: 'pen-ruler' },
    { title: 'نقل الجلسات والجدول + بطاقة "منصة التوقيع"', description: 'نقل أماكن الجلسات والاستشارات والجدول إلى التنظيمية، وإلغاء لجنة الشراكات مع نقل خصائصها إلى الإعلامية في بطاقة باسم "منصة التوقيع"', priority: 'urgent', icon: 'arrows-rotate' },
  ...
  structure: [
    ...
    { title: 'إعادة هيكلة الخصائص لكل لجنة — v2', description: 'توسيع ما بدأ في الحزمة العاجلة إلى كامل اللجان وبقية العملاء', priority: 'high', icon: 'arrows-rotate' },
    { title: 'تطبيق التصميم الموحد (Design System) — v2', description: 'بعد إعادة تصميم الإدمن في الحزمة العاجلة، بناء مكتبة مكونات موحّدة تُطبّق تدريجياً', priority: 'medium', icon: 'palette' },
  ...
  features: [
    ...
    { title: 'قوالب جاهزة للأقسام — v2', description: 'توسيع الثيمين العاجلين إلى مكتبة قوالب كاملة لكل أقسام الواجهة الخارجية', priority: 'medium', icon: 'clone' },
    ...
    { title: 'دمج وتوحيد بنية اللجان — v2', description: 'توثيق رسمي للبنية الجديدة بعد إلغاء الشراكات في الحزمة العاجلة', priority: 'medium', icon: 'merge' },
  ],
  technical: [
    { title: 'تقارير مؤشرات الأداء — v2', description: 'توسيع الحزمة العاجلة: تقارير لحظية لكل لجنة وتقرير ختامي شامل وتصدير PDF و Excel', priority: 'high', icon: 'chart-line-up' },
...
export const roadmapTimeline = [
  {
    ...
    items: [
      ...
      'إعادة تصميم واجهات مدير النظام + ثيمان للواجهة الخارجية (Themes)',
      'نقل الجلسات والجدول إلى التنظيمية + إلغاء الشراكات في بطاقة "منصة التوقيع"',
      'تطوير التقارير ولوحة المعلومات (حضور، بطاقات، ورش، رسوم بيانية)',
    ],
  },
  {
    quarter: 'مايو – يونيو 2026',
    items: ['خطة الوحدات (Modules)', 'إعادة هيكلة الخصائص لكل لجنة — v2', 'دمج وتوحيد بنية اللجان — v2'],
  },
  {
    quarter: 'يوليو – أغسطس 2026',
    items: ['تطوير خارطة المعرض', 'تمكين التوقيع الإلكتروني', 'قوالب جاهزة للأقسام — v2', 'خصومات الفنادق والطيران'],
  },
  {
    quarter: 'سبتمبر – أكتوبر 2026',
    items: ['التكامل مع النفاذ الوطني', 'بناء الأقسام بالسحب والإفلات', 'تقارير مؤشرات الأداء — v2', 'تطوير الدعوات التفاعلية'],
  },
  {
    quarter: 'نوفمبر – ديسمبر 2026',
    items: ['التكامل مع أجهزة الخدمات الذاتية', 'تطبيق الهواتف الذكية', 'ربط الذكاء الاصطناعي', 'تطبيق التصميم الموحد — v2'],
  },
];
