// asanaClassification.js
// نسخة لـ React app من asana-integration/scripts/classification.js
// يجب أن يبقى متطابقاً معه — هو مصدر الحقيقة في asana-integration/.
...
export const DEFAULTS = {
  pmName: 'أحمد محمد',
  analystName: 'سارة علي',
  product: 'نظم (Nadhem)',
  company: 'شركة التحول التقني (TTS)',
};
